 ...
 */
require_once ENGINE_URL.FOLDER_CLASS_EXT.'zend/Http/Client.php';
        ...
        $body = null, $contentType = null, $remainingRedirects = null)
    {
        ...
        if ($body instanceof Zend_Gdata_MediaMimeStream) {
            ...
            if ($oldHttpAdapter instanceof Zend_Http_Client_Adapter_Proxy) {
                require_once  ENGINE_URL.FOLDER_CLASS_EXT.'zend/Gdata/HttpAdapterStreamingProxy.php';
                $newAdapter = new Zend_Gdata_HttpAdapterStreamingProxy();
            } else {
                require_once  ENGINE_URL.FOLDER_CLASS_EXT.'zend/Gdata/HttpAdapterStreamingSocket.php';
