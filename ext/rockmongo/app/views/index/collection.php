...
<table>
	...
	<tr>
		<td>Data Type:</td>
		<td><?php h(render_select_data_types("data_type", "string")); ?> <select name="format" onchange="switchDataFormat('#field_dialog_new textarea[name=\'mixed_value\']',this)" style="display:none">
...
<table>
	...
	<tr>
		<td>Data Type:</td>
		<td><?php h(render_select_data_types("data_type", "integer")); ?> <select name="format" onchange="switchDataFormat('#field_dialog_update textarea[name=\'mixed_value\']',this)" style="display:none">
<option value="array" <?php if($last_format=="array"): ?>selected="selected"<?php endif; ?>>Array</option>
<option value="json" <?php if($last_format=="json"): ?>selected="selected"<?php endif; ?>>JSON</option>
</select></td>
	</tr>
